"""
Django settings for profiles_config project.
"""
...
ROOT_URLCONF = 'profiles_config.urls'
...
WSGI_APPLICATION = 'profiles_config.wsgi.application'

# Database - PostgreSQL
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'profiles_db'),
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,  # Más resultados por página que Auth
