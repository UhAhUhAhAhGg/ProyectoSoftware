        ...
        <div className="header-right">
          ...
          <span className="user-badge">
            <span className="material-symbols-outlined" style={{ fontSize: '18px', verticalAlign: 'middle' }}>
              {isComprador ? 'shopping_bag' : 'campaign'}
            </span>{' '}
            {isComprador ? 'Comprador' : 'Promotor'}
          </span>
          
          <button onClick={logout} className="btn-logout" title="Cerrar sesión">
            <span className="btn-icono material-symbols-outlined">logout</span>
        ...
        <nav className="sidebar-nav">
          ...
          <ul>
            {isComprador ? (
              ...
              <>
                <li><a href="/dashboard/eventos"><span className="material-symbols-outlined">confirmation_number</span> Explorar Eventos</a></li>
                <li><a href="/dashboard/boletos"><span className="material-symbols-outlined">ticket</span> Mis Boletos</a></li>
                <li><a href="/dashboard/favoritos"><span className="material-symbols-outlined">favorite</span> Favoritos</a></li>
                <li><a href="/dashboard/historial"><span className="material-symbols-outlined">history</span> Historial</a></li>
              </>
            ) : (
              // Enlaces rápidos para promotor
              <>
                <li><a href="/dashboard/crear-evento"><span className="material-symbols-outlined">add</span> Crear Evento</a></li>
                <li><a href="/dashboard/mis-eventos"><span className="material-symbols-outlined">event</span> Mis Eventos</a></li>
                <li><a href="/dashboard/ventas"><span className="material-symbols-outlined">attach_money</span> Ventas</a></li>
                <li><a href="/dashboard/estadisticas"><span className="material-symbols-outlined">analytics</span> Estadísticas</a></li>
              </>
            )}
          </ul>
        </nav>
