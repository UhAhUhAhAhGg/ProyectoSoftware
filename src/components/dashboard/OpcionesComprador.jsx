  ...
  return (
    <div className="opciones-comprador">
      ...
      <div className="acciones-rapidas">
        <Link to="/dashboard/explorar" className="accion-rapida principal">
          <span className="accion-icono material-symbols-outlined">search</span>
          <span className="accion-texto">Explorar Eventos</span>
        </Link>
        <Link to="/dashboard/proximos" className="accion-rapida secundaria">
          <span className="accion-icono material-symbols-outlined">calendar_month</span>
        ...
        {opciones.map(opcion => (
          <Link to={opcion.link} key={opcion.id} className="opcion-card">
            <div className="opcion-header" style={{ backgroundColor: opcion.color + '20' }}>
              <span className="opcion-icono material-symbols-outlined" style={{ color: opcion.color }}>{opcion.icono}</span>
              {opcion.contador && (
